      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-gray-900">
                Product <span className="text-transparent bg-clip-text bg-linear-to-r from-[#7d2e3d] to-[#8f3545]">Tie-Ups</span>
            </h2>
            <div className="w-20 h-1.5 bg-linear-to-r from-[#7d2e3d] to-[#d4af37] mx-auto mt-4 rounded-full" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {tieUps.map((item, index) => (
            ...
            >
                <div className="absolute top-0 left-0 w-1 h-full bg-linear-to-b from-[#7d2e3d] to-[#8f3545] transform scale-y-0 group-hover:scale-y-100 transition-transform duration-300 origin-top" />
          ...
          {tieUps.length % 3 !== 0 && (
            <div className="hidden lg:block lg:col-span-1 bg-linear-to-br from-slate-900 to-blue-900 rounded-2xl p-8 text-white flex flex-col justify-center items-center text-center shadow-lg relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <button className="px-6 py-2 bg-linear-to-r from-[#7d2e3d] to-[#8f3545] rounded-full font-bold text-sm shadow-lg hover:shadow-[#7d2e3d]/50 transition-all duration-300 transform hover:scale-105">
                      Contact Us
                  </button>
                </div>
            </div>
