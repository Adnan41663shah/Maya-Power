...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-linear-to-b from-white via-gray-50 to-white pt-16 md:pt-20 pb-32 sm:pb-40 md:pb-48 lg:pb-56"
    ...
    >
      ...
      >
        <div className="relative w-[500px] h-[500px] sm:w-[600px] sm:h-[600px] md:w-[800px] md:h-[800px] lg:w-[1000px] lg:h-[1000px]">
          ...
          {/* Inner Solar Cell */}
          <div className="absolute inset-16 bg-linear-to-br from-[#7d2e3d]/30 to-[#4a7c59]/30 rounded-lg transform rotate-45 animate-pulse-glow">
            <div className="absolute inset-2 bg-linear-to-br from-[#7d2e3d]/50 to-[#4a7c59]/50 rounded-lg" />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full py-8 sm:py-12 md:py-16 flex-1 flex flex-col items-center justify-center overflow-visible">
        ...
        <div className="mb-4 sm:mb-6 pb-3 sm:pb-4 md:pb-5 overflow-visible">
          <h1
            ref={headlineRef}
            className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-[#7d2e3d] via-[#d4af37] to-[#7d2e3d] animate-gradient-shift opacity-0 transition-all duration-700"
        ...
        >
          <button
            onClick={openModal}
            className="inline-block px-8 py-4 sm:px-10 sm:py-5 bg-linear-to-r from-[#7d2e3d] via-[#8f3545] to-[#d4af37] text-white font-bold text-lg sm:text-xl rounded-lg hover:shadow-2xl hover:shadow-[#7d2e3d]/50 transition-all duration-300 hover:scale-110 animate-pulse-border cursor-pointer"
          >
            Get a Projection
          </button>
        </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 sm:h-32 md:h-40 lg:h-42 z-10 pointer-events-none">
        <div className="absolute inset-0 bg-linear-to-b from-transparent via-white/60 to-white backdrop-blur-sm" />
        <div className="absolute bottom-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-[#7d2e3d]/30 to-transparent" />
      </div>
    </section>
  );
};
